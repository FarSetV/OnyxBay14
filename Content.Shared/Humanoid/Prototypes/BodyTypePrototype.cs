...
public sealed class BodyTypePrototype : IPrototype
{
    ...
    /// </summary>
    [DataField("sexRestrictions")] public List<string> SexRestrictions = new();
    ...
    ///     be ignored.
    /// </summary>
    [DataField("sprites", required: true)] public Dictionary<HumanoidVisualLayers, string> Sprites = new();
