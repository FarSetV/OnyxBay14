...
ui-options-function-focus-admin-chat-window = Фокус на чат (Admin)
ui-options-function-focus-dead-chat-window = Фокус на чат (Dead)
ui-options-function-focus-console-chat-window = Фокус на чат (Console)
