...
lobby-state-round-start-countdown-text = Начало через: {$timeLeft}
lobby-state-ready-button-join-state = Войти
...
lobby-state-player-status-observer = Наблюдать
lobby-state-player-status-round-not-started = Раунд ещё не начался
lobby-state-player-status-round-time = Раунд длится: {$hours} часов и {$minutes} минут
